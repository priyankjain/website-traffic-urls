...
{
    global $bitly_access_token,$long_url,$bitly_file,$owly_file,$owly_access_token, $count_file,$count;
...
$file = fopen("longurl.txt","w");
fputs($file,$long_url.PHP_EOL.$get_param);
fclose($file);
